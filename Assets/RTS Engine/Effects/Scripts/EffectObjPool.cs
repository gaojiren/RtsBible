...
namespace RTSEngine
{
    public class EffectObjPool : MonoBehaviour
    {
        ...
        public enum EffectObjTypes {UnitDamageEffect, BuildingDamageEffect, AttackObjEffect, AttackObj, upgradeEffect};
        ...
        List<GameObject> upgradeEffects = new List<GameObject>();
        ...
        public GameObject GetEffectObj(EffectObjTypes Type, EffectObj Prefab)
        {
            ...
            switch (Type)
            {
                ...
                case EffectObjTypes.AttackObj:
                    ...
                    break;
                case EffectObjTypes.upgradeEffect:
                    SearchList = upgradeEffects;
                    break;
                default:
